...
addpath(genpath('/Users/coxm/Documents/SpikeSorting/KiloSort')) % path to kilosort folder
addpath(genpath('/Users/coxm/Documents/SpikeSorting/npy-matlab')) % path to npy-matlab scripts
pathToYourConfigFile = '/Users/coxm/Documents/SpikeSorting/KiloSort/eMouse/'; % for this example it's ok to leave this path inside the repo, but for your own config file you *must* put it somewhere else!  
